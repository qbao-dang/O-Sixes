...
var ssl_options = {
  key: fs.readFileSync(path.join(rootPath, 'ssl/osixes.com.key')),
  cert: fs.readFileSync(path.join(rootPath, 'ssl/osixes.com.crt'))
};
...
var properties = propertyReader('/resources/config.properties');
var appKey = properties.getElementsByClassName('consumerKey');
var appSecret = properties.getElementById('consumerSecret')
app.set('BNET_ID', appKey);
app.set('BNET_SECRET', consumerSecret);
